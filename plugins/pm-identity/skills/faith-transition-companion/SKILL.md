...
description: "Summarise what Faith Transition Companion does in one line. Use when asked to [trigger phrases the user would say]. Produces [the concrete artifact]."
---

# Faith Transition Companion Skill
