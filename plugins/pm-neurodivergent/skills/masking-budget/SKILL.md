---
name: masking-budget
description: "Summarise what Masking Budget does in one line. Use when asked to [trigger phrases the user would say]. Produces [the concrete artifact]."
---

# Masking Budget Skill
