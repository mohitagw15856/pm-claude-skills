...
description: "Summarise what Disability Disclosure Decision does in one line. Use when asked to [trigger phrases the user would say]. Produces [the concrete artifact]."
---

# Disability Disclosure Decision Skill
