...
description: "Summarise what Credit From Scratch does in one line. Use when asked to [trigger phrases the user would say]. Produces [the concrete artifact]."
---

# Credit From Scratch Skill
