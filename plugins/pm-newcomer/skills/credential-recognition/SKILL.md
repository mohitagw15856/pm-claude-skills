...
description: "Summarise what Credential Recognition does in one line. Use when asked to [trigger phrases the user would say]. Produces [the concrete artifact]."
---
