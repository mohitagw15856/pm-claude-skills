# The State of Agent Skills — 2026-07-06
...
## The sample, actually graded (118 files, one per repo)
...
- **"Use when" adoption in the sample:** 32% of descriptions
- **Security-pattern hits:** 0 of 118 sampled files (0%) contained instruction-override or exfiltration phrasing — the reason installers should scan before installing
- **Median skill size:** 4.3 KB · **Fork share of sample:** 0%
