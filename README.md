# 🧠 PM Skills — 411 Professional Agent Skills for Claude, ChatGPT, Gemini, Cursor, Codex & Hermes
...
[![Skills](https://img.shields.io/badge/skills-411-blue)](https://github.com/mohitagw15856/pm-claude-skills)
...
<p align="center">
  <a href="https://mohitagw15856.github.io/pm-claude-skills/">
    <img src="https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=24&pause=900&color=D97757&center=true&vCenter=true&width=720&lines=411+pro+AI+skills;PRDs%2C+roadmaps%2C+launches+%E2%80%94+done+right;Run+any+one+free+in+your+browser" alt="PM Skills" />
  </a>
</p>
...
> 411 professional skills + 4 agent templates across 59 bundles covering 25 professions. Built for Claude Code — and now portable to ChatGPT, Gemini, and Hermes Agent. Built by a PM, used by everyone.

A community-built library of professional skills for every field — product management, engineering, customer success, marketing, social media, writers, design, legal, finance, HR, sales, operations, research, and more. Each skill is a structured `SKILL.md` file that teaches an AI assistant how to produce professional-grade outputs for your workflows. Skills run natively in **Claude Code** and **Hermes Agent** (same open `SKILL.md` standard), and ship as ready-to-paste exports for **ChatGPT** and **Gemini** — see [Works With](#-works-with--cross-tool-compatibility).

**🆕 Latest — v36.0.0 (Security & Government bundles, Fable 5 & an always-current catalog):** two new professional domains — **🔒 `pm-security`** (hands-on appsec: `threat-model` STRIDE, `security-review`, `vuln-triage` CVSS, `security-incident-response`, `pentest-report` — defensive & authorized-testing framing) and **🏛️ `pm-gov`** (`rfp-response`, `policy-memo`, `public-comment`, `briefing-note`, `foia-request`, `regulatory-impact-analysis`). The playground now offers **Fable 5 ✨**, the newest model, as the default. And **`SKILLS.md` is auto-generated** from the catalog (grouped by domain), so the full listing can never go stale again. *Earlier (v35.0):* the `pm-pmm` Product Marketing bundle, Custom GPT / Gemini Gem, and Raycast/Alfred launchers. **411 skills across 59 bundles.** → **[Full release history & notes](https://github.com/mohitagw15856/pm-claude-skills/releases)**.
...
The whole library on one page — install, all 411 skills by profession, the Professional Brain, the REST API, integrations, and quality tooling. Great to **print, share, or drop into a slide**.

<p align="center">
  <a href="CHEATSHEET.md">
    <img src="web/docs-assets/cheatsheet.png" width="80%" alt="PM Skills one-page cheatsheet — 411 skills, the Professional Brain, REST API, integrations, and tooling at a glance." />
  </a>
</p>
...
These 411 skills aren't a random catalog — they cover the **full arc of professional work**, end to end. Wherever you are in the loop, there's a skill for it:
...
> New here? Start with the [**top-tier skills**](#️-skill-tiers--start-with-the-strongest), or jump straight to [**all 411 skills**](#️-all-411-skills) grouped by profession.
...
|---|:---:|:---:|
| Skills | **411**, across 25 professions | a handful → dozens, usually one domain |
...
**With the [`skills`](https://github.com/vercel-labs/skills) CLI** (the open agent-skills installer that works across Claude Code, Cursor, Codex, OpenCode & 60+ agents) — pick from all 411 interactively:
...
npx skills add mohitagw15856/pm-claude-skills --skill '*'            # install all 411
```
...
**Or one-line MCP** — make all 411 skills + 5 workflow recipes available in *every* session of any MCP client (Claude Code, Claude Desktop, Cursor, Windsurf), no per-file install:
...
The same 411 skills reach you through every channel — pick whatever fits your stack:
...
> **208 of 411 skills are eval-scored, averaging 4.8/5** — see the [leaderboard](https://mohitagw15856.github.io/pm-claude-skills/leaderboard.html).
...
**In your editor (VS Code / Cursor):** the [**`vscode-extension/`**](vscode-extension/) brings all 411 skills into the Command Palette — search and *insert a skill as context* for Copilot/Cursor chat, copy it, or open it in the Playground.
...
This library is the largest open-source collection of professional skills available — covering 20 professions beyond financial services. **The 411 skills here are the building blocks for agent templates outside of finance.**
...
**Latest: v32.0.0 — 4 new bundles, 24 skills (E-commerce, UX Writing, Recruiting, Accounting).** 411 skills across 59 bundles, 25 professions. Every tagged release has complete notes on the **[Releases page](https://github.com/mohitagw15856/pm-claude-skills/releases)**.
...
A 411-skill library doesn't have 411 equally-mature skills, and pretending otherwise
...
Building and maintaining 411 skills across 59 bundles takes real time — testing skills against new model releases, building new ones from community requests, writing the article series, and keeping documentation current.
...
eval-scored or security-audited** (that's the [curated library](#️-all-411-skills) above). Want
...
| 5,000 ⭐ | Public **contributor leaderboard** + the push to 411 skills | 🔒 Locked |
