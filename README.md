# 🧠 PM Skills — 515 Professional Agent Skills for Claude, ChatGPT, Gemini, Cursor, Codex & Hermes
...
> 515 professional skills + 4 agent templates across 74 bundles covering 31 professions. Built for Claude Code — and now portable to ChatGPT, Gemini, and Hermes Agent. Built by a PM, used by everyone.

A community-built library of professional skills for every field — product management, engineering, customer success, marketing, social media, writers, design, legal, finance, HR, sales, operations, research, and more. Each skill is a structured `SKILL.md` file that teaches an AI assistant how to produce professional-grade outputs for your workflows. Skills run natively in **Claude Code** and **Hermes Agent** (same open `SKILL.md` standard), and ship as ready-to-paste exports for **ChatGPT** and **Gemini** — see [Works With](#-works-with--cross-tool-compatibility).

**🆕 v51.0.0 — the artifact release:** skills stop answering and start producing — 🏭 **[Make it real](https://mohitagw15856.github.io/pm-claude-skills/make.html)** turns any output into a real, on-brand deliverable and builds **[The Packet](https://mohitagw15856.github.io/pm-claude-skills/make.html)** (one brief → a `.zip` of `PRD.doc` + `plan.xlsx` + `deck.pptx`), 🎨 a **Brand Kit** (your logo + colours on every export, all local), 🧮 **live-formula Excel** and 🖼️ auto-designed **one-pagers**; 🗒️ **[Meeting → artifacts](https://mohitagw15856.github.io/pm-claude-skills/meeting.html)** turns a transcript into minutes + an action tracker + follow-up emails, 📊 **[Bring your own data](https://mohitagw15856.github.io/pm-claude-skills/data.html)** grounds a skill in your real CSV/Sheet (with 🌐 one-click translation into 10 languages), and 🌐 the **[Site builder](https://mohitagw15856.github.io/pm-claude-skills/site.html)** emits a self-contained website or a **living document** that stays interactive after download. Plus 💬 **[Consultant Mode](https://mohitagw15856.github.io/pm-claude-skills/consult.html)** (run any skill as an adaptive interview), 🤖 **[SkillBench model rankings](https://mohitagw15856.github.io/pm-claude-skills/modelbench.html)**, 🌱 a **self-growing library**, and 📕 the **[Handbook paperback](https://www.lulu.com/shop/mohit-aggarwal/the-professional-work-handbook/paperback/product-65kwrpk.html)**. **515 skills · 74 bundles.** *Earlier — v50, the wow release:* AI that reads your fine print and argues back — 🔍 **[pm-decoders](plugins/pm-decoders)** (lease, medical bill, ToS, loan, benefits, HOA — plain English, ranked red flags, what's negotiable), ⚔️ **[pm-simulators](plugins/pm-simulators)** (opposing counsel drafts the letter they'd send you, the VC partner meeting after you leave the room, regulator eyes, the customer who quietly churns, the acquirer's red team), 🧮 **four more skills that do real math** (exit-waterfall with computed conversion points, offer-comparison vesting curves, refinance-breakeven with the term-reset trap, fire-number's honesty grid — all CI-pinned), ✨ plus **[receipts-audit](skills/receipts-audit/SKILL.md)** (every claim graded against sources), **[personal-board-of-directors](skills/personal-board-of-directors/SKILL.md)**, **[altitude-shifter](skills/altitude-shifter/SKILL.md)** and **[decision-forensics](skills/decision-forensics/SKILL.md)**. **515 skills · 74 bundles · 31 professions.** *Earlier — v49, the professions release:* six industries nobody built AI for — 🏗 **[pm-construction](plugins/pm-construction)** (bid review, change orders, punch lists, toolbox talks, delay claims), 🔧 **[pm-hardware](plugins/pm-hardware)** (hardware PRDs, BOM review, EVT/DVT/PVT gates, FAT, tooling risk, 8D), 📦 **[pm-supplychain](plugins/pm-supplychain)**, 🌍 **[pm-climate](plugins/pm-climate)** (with a greenwashing self-audit), 🛡 **[pm-insurance](plugins/pm-insurance)** + 🏦 **[pm-banking](plugins/pm-banking)** — plus depth: 📖 worked examples on all 50 production skills, 🎯 0–40 scoring rubrics on all 50, ⌨️ CLI field-by-field prompting, 📜 **[SkillSpec in its own repo](https://github.com/mohitagw15856/skillspec)**. *Earlier — v48, the institution release:* 🏛 **[The Open Institute for Professional Judgment](https://mohitagw15856.github.io/pm-claude-skills/institute.html)** — SkillSpec (+ its [foundation trajectory](docs/FOUNDATION.md)), the Operator's Exam, SkillBench rankings, the census, the Season (with the Hall + automated rollover), and **[The State of Professional AI 2026](docs/reports/state-of-professional-ai-2026.md)**; 🏢 the **[Org Edition](org/)** (`docker compose up` = your company's library on your infra), 🎓 the **[6-week Syllabus](docs/syllabus/)** with SCORM export, 🎖 **[Agent Conformance](conformance/)** certification, 💼 the **[creator economy](docs/CREATORS.md)** (0% take). Plus the frontier wave: 🏆 the Season is OPEN, 🌙 the Nightwatch, ⏰ standing skills, 🗺 the Atlas, 📻 the Morning Show, 👥 multiplayer Boardroom, 🧠 the 7b pipeline. *Earlier — v46, the arsenal release:* ⚔️ **[`pm-warroom`](plugins/pm-warroom)** — the adversarial bundle (Premortem Assassin's twelve failure vectors, Devil's Twin writes the opposition's best memo, Metric Gaslighting Detector's eleven distortions, Decision Autopsy, Assumption Bounty), 🧮 **three more skills that do real math** (Erlang-C staffing, schedule Monte Carlo over the task DAG, tornado sensitivity — CI-pinned exact outputs), 🎭 shareable singles (eulogy-writer, wedding-speech, fine-appeal-letter, skill-fusion), 🎨 **generative identities on every skill page and playground card** (five banner families seeded from the name, matching colours + monograms, ⓘ links), 🎯 **466/466 SkillSpec L3 — CI-enforced**, 🧪 the 76-assertion scripts harness, 📱 the **PWA** (no-API core offline), 📈 [public vitals](https://mohitagw15856.github.io/pm-claude-skills/status.html) + self-operating crons, 🗺 [REPO-MAP](REPO-MAP.md). **466 skills · 66 bundles.** *Earlier — v45, the spectacle release:* Duels, the Charter, Galaxy 3D, the collapsing Tower of Claims, the Stage, holo cards & Skill City. *Earlier — v44, the legendary release:* Campaign mode, the Professional Work Handbook (2,470-rule Anti-Pattern Almanac), the Reckoning, the ecosystem package manager, zero-key MCP sampling, pm-skills-tools, the SkillSpec badge & the census. *Earlier — v43, the local-first & learning wave:* the 🗂 workspace bridge, Boardroom replay links & bench packs, 🎤 The Panel, 🎓 The Academy, 🎁 Wrapped, the evolution loop & pm-method. *Earlier — v42:* depth (`references/` + `templates/`) on all Production-Ready skills, 🔊 Theatre voices, Firm calibration & the CI smoke suite. *Earlier — v41, the modern skills wave:* two new domains — **🤖 [`pm-agentnative`](plugins/pm-agentnative)** (build for non-human users: [`mcp-server-spec`](skills/mcp-server-spec/SKILL.md), [`agent-readiness-audit`](skills/agent-readiness-audit/SKILL.md), [`agent-era-pricing`](skills/agent-era-pricing/SKILL.md), [`human-in-the-loop-design`](skills/human-in-the-loop-design/SKILL.md), [`voice-agent-design`](skills/voice-agent-design/SKILL.md)) and **🧑‍💼 [`pm-aiwork`](plugins/pm-aiwork)** (the questions every manager has this year: [`ai-roi-audit`](skills/ai-roi-audit/SKILL.md), [`role-redesign-for-ai`](skills/role-redesign-for-ai/SKILL.md), [`ai-usage-policy`](skills/ai-usage-policy/SKILL.md), [`ai-assisted-performance-review`](skills/ai-assisted-performance-review/SKILL.md), [`ai-content-audit`](skills/ai-content-audit/SKILL.md)) — plus 5 singles ([`ai-code-review`](skills/ai-code-review/SKILL.md), [`synthetic-user-research`](skills/synthetic-user-research/SKILL.md), [`async-decision-memo`](skills/async-decision-memo/SKILL.md), [`brand-impersonation-response`](skills/brand-impersonation-response/SKILL.md), [`feature-sunset-plan`](skills/feature-sunset-plan/SKILL.md)). Also: 🌠 Galaxy shooting stars + a 🎲 Warp button, 🎓 frameable [certificates](web/export-doc.js) from the arena pages, and 🔌 [MCP pairings](connectors/mcp-pairings.md) — skills that act through your connected servers. *Earlier — v40: [The Firm](https://mohitagw15856.github.io/pm-claude-skills/firm.html). v39 (three waves):* ⚡ *Superpowers:* [SkillBench](skillbench/) (the professional-work benchmark for models) · the [community registry](community/) (npm-for-skills) · the [Interview Gauntlet](https://mohitagw15856.github.io/pm-claude-skills/gauntlet.html) · [CI recipes](action/examples/) + [ambient hooks](hooks/) · Hugging Face [dataset publishing](dataset/) · [localization to 8 languages](i18n/). 🤯 *Breathtaking:* [living artifacts](https://mohitagw15856.github.io/pm-claude-skills/), [Document X-ray](https://mohitagw15856.github.io/pm-claude-skills/xray.html), [The Gym](https://mohitagw15856.github.io/pm-claude-skills/gym.html), [`pm-vision`](plugins/pm-vision), [`style-fingerprint`](skills/style-fingerprint/SKILL.md), [`evidence-lock`](skills/evidence-lock/SKILL.md). ✨ *Revamped:* the playground command bar + Galaxy 2.0 with a guided Sky tour. **466 skills · 66 bundles · 25 professions.** → [CHANGELOG](CHANGELOG.md) · [all releases](https://github.com/mohitagw15856/pm-claude-skills/releases).
...
These 515 skills aren't a random catalog — they cover the **full arc of professional work**, end to end. Wherever you are in the loop, there's a skill for it:
...
> New here? Start with the [**top-tier skills**](#️-skill-tiers--start-with-the-strongest), or jump straight to [**all 515 skills**](#️-all-skills-by-profession) grouped by profession.
...
- **[Galaxy 3D](https://mohitagw15856.github.io/pm-claude-skills/galaxy3d.html)** — 515 skills as a bloom-lit starfield you fly through; **your sky is yours** (stars you've run burn brighter). **[Skill City](https://mohitagw15856.github.io/pm-claude-skills/city.html)** — the same idea as a dusk skyline: windows light up in buildings you've used.
...
- **[The Professional Work Handbook](https://mohitagw15856.github.io/pm-claude-skills/handbook.html)** — the library as a book: 11 chapters of craft (the Production-Ready tier in full) + **the Anti-Pattern Almanac: 2,237 rules of professional judgment** from all 515 skills. Read it free online, grab the [PDF](web/docs-assets/handbook.pdf), or **[📕 order the paperback on Lulu](https://www.lulu.com/shop/mohit-aggarwal/the-professional-work-handbook/paperback/product-65kwrpk.html)** — the digital editions stay free forever; print is a format, not a paywall.
...
- **[`pm-skills-tools`](tools-pkg/)** — all 515 skills as **agent tools**: OpenAI function schemas, Vercel AI SDK adapters, `pick()`/`search()` runtime. `npm i pm-skills-tools` and your agent wields the library.
...
|---|:---:|:---:|
| Skills | **515**, across 31 professions | a handful → dozens, usually one domain |
...
**With the [`skills`](https://github.com/vercel-labs/skills) CLI** (the open agent-skills installer that works across Claude Code, Cursor, Codex, OpenCode & 60+ agents) — pick from all 515 interactively:
...
npx skills add mohitagw15856/pm-claude-skills --skill '*'            # install all 515
```
...
**Or one-line MCP** — make all 515 skills + 11 workflow recipes available in *every* session of any MCP client (Claude Code, Claude Desktop, Cursor, Windsurf), no per-file install:
...
claude plugin install pm-engineering@pm-claude-skills    # Engineering (45 skills) 🆕
...
The same 515 skills reach you through every channel — pick whatever fits your stack:
...
**In your editor (VS Code / Cursor):** the [**`vscode-extension/`**](vscode-extension/) brings all 515 skills into the Command Palette — search and *insert a skill as context* for Copilot/Cursor chat, copy it, or open it in the Playground.
...
| **pm-engineering** | 45 skills across API docs, architecture, CI/CD, incident response, security, observability, and more | The largest plugin — built for PMs embedded in engineering teams. Covers technical specs, runbooks, on-call processes, architecture decisions, and engineering hiring. |
...
This library is the largest open-source collection of professional skills available — covering 20 professions beyond financial services. **The 515 skills here are the building blocks for agent templates outside of finance.**
...
**Latest: v51.0.0 — the artifact release: skills produce real deliverables — Make it real & the Packet (one brief → a zip of PRD.doc + plan.xlsx + deck.pptx), a local Brand Kit on every export, live-formula Excel, auto one-pagers, Meeting → artifacts (minutes + action tracker + emails), Bring-your-own-data grounding + translation into 10 languages, a Site builder that emits self-contained sites & living documents, Consultant Mode, SkillBench model rankings, the self-growing library, and the Handbook paperback on Lulu — 515 skills, 74 bundles** · *v50, the wow release:* pm-decoders (AI reads your lease, medical bill, ToS, loan, benefits and HOA fine print), pm-simulators (opposing counsel, the VC partner meeting, regulator eyes, the churning customer, the acquirer's red team), four more CI-pinned calculators (exit waterfall, offer comparison, refi breakeven, FIRE grid), receipts-audit, the personal board of directors, altitude-shifter and decision-forensics · *v49, the professions release:* 30 new skills for construction, hardware, supply chain, climate/ESG, insurance and banking, worked examples + 0–40 scoring rubrics on all 50 production skills, CLI field-by-field prompting, and SkillSpec spun out to its own RFC-governed repo · *v48, the institution release:* the Open Institute, the Org Edition, the Syllabus with SCORM, Agent Conformance, the creator economy (0% take), the Season + Nightwatch + Atlas + Morning Show · *v47, the off-web release:* text or call a skill (signature-verified Twilio Worker), the email-native operator, the printable Operator's Deck with QR deep-links, Run the Firm tycoon game, the local-only Watch-me-work coach extension, and the auto morning-show newsletter — plus a 🆕 New nav group + scrollable dropdowns · *v46, the arsenal release:* the pm-warroom adversarial bundle, three more computed skills, the shareable singles, generative identities everywhere, 466/466 L3 CI-enforced, the PWA, public vitals & the self-operating crons · *v44:* Campaign mode, the Handbook, the Reckoning, the ecosystem package manager, zero-key MCP sampling, pm-skills-tools, the badge & the census · *v43:* the workspace bridge, replay links & bench packs, The Panel, The Academy, Wrapped, the evolution loop & pm-method · *v42:* depth on all Production-Ready skills, arena voices, Firm calibration & the web-tests safety net · *v41, modern skills:* [`pm-agentnative`](plugins/pm-agentnative) + [`pm-aiwork`](plugins/pm-aiwork) (15 skills for the agent era), Galaxy cosmic events, 🎓 certificates & [MCP pairings](connectors/mcp-pairings.md) · *v40: [The Firm](https://mohitagw15856.github.io/pm-claude-skills/firm.html) · v39, three waves:* [SkillBench](skillbench/), the [community registry](community/), the [Interview Gauntlet](https://mohitagw15856.github.io/pm-claude-skills/gauntlet.html), [living artifacts](https://mohitagw15856.github.io/pm-claude-skills/), [Document X-ray](https://mohitagw15856.github.io/pm-claude-skills/xray.html), [The Gym](https://mohitagw15856.github.io/pm-claude-skills/gym.html), pm-vision, i18n, HF publishing, CI recipes & the Galaxy Sky tour. 515 skills across 74 bundles, 31 professions. Every tagged release has complete notes on the **[Releases page](https://github.com/mohitagw15856/pm-claude-skills/releases)**.
...
A 515-skill library doesn't have 515 equally-mature skills, and pretending otherwise
...
Building and maintaining 515 skills across 74 bundles takes real time — testing skills against new model releases, building new ones from community requests, writing the article series, and keeping documentation current.
...
eval-scored or security-audited** (that's the [curated library](#️-all-skills-by-profession) above). Want
...
The 515 skills in this library are built for general professional workflows. But the most powerful version of Claude Skills is one built specifically for *your* team — your templates, your terminology, your processes, your quality standards.
...
| 5,000 ⭐ | Public **contributor leaderboard** + the push to 600 skills | 🔒 Locked |
