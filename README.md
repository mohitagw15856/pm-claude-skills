...
**v61.1.0 — the demand side:** **[find](https://mohitagw15856.github.io/pm-claude-skills/find.html)** — a natural-language task→skill router (`pm-claude-skills find "prep a QBR"`) with an honest per-skill **measured / no-claim** badge; **per-skill versioning** (`version:` frontmatter + a git-derived `changelog` command); and **[SkillSpec as an adoptable standard](conformance/REGISTRY.md)** — an earnable `--badge` any repo generates from its own CI, plus a public conformance registry. *Earlier — v61, the trust layer:* **[prove](CHANGELOG.md)** (A/B-verify any skill), **mcp-audit**, **[pm-seatbelt](plugins/pm-seatbelt)** (6 agent-safety skills), and the [Cowork](https://mohitagw15856.github.io/pm-claude-skills/cowork.html) + [AI Spend](https://mohitagw15856.github.io/pm-claude-skills/spend.html) pages. Full history: **[CHANGELOG](CHANGELOG.md)** · [releases](https://github.com/mohitagw15856/pm-claude-skills/releases)
