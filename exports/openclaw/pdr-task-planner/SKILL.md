---
name: pdr-task-planner
description: "Turn a feature request into a concise Product Development Requirement plus implementation-sized tasks registered in a Git-backed task ledger. Use when asked to plan feature work, write a PDR, break a request into tasks, or set up a Kanban backlog with dependencies. Produces a PDR document and created task records with IDs, requirements, acceptance criteria, and dependency order."
homepage: https://mohitagw15856.github.io/pm-claude-skills/skill/pdr-task-planner.html
metadata:
  {
    "openclaw": { "emoji": "🧠" }
  }
