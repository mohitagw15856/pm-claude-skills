# The State of Agent Skills — 2026-08-25
...
|---|---:|---|
| Any `SKILL.md` | ~4,694,272 | The raw surface — includes forks, exports, experiments |
| With frontmatter `description:` | ~4,243,712 | Loadable by agents — the working definition of a skill |
| With **"Use when"** triggers | ~2,536,960 | Auto-discovery discipline (the convention that makes skills fire) |
| With **Anti-Patterns** | ~431,232 | Self-critical craft — the L3 signal |
| With **Quality Checks** | ~64,304 | Full self-verification (SkillSpec L3 house style) |
...
| **L1 Loadable** (frontmatter only) | 97% |
| **L0 Not loadable** (broken/absent frontmatter) | 0% |

- **"Use when" adoption in the sample:** 42% of descriptions
...
- **Median skill size:** 4.2 KB · **Fork share of sample:** 0%
