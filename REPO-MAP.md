...
| **Read/copy skills** | [`skills/`](skills/) — 1169 folders, one `SKILL.md` each (~9 MB total) | ✔ |
...
|---|---|---|
| `skills/` | **The product.** 1169 skill definitions + their references/templates/scripts | hand-written |
