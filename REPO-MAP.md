...
| **Read/copy skills** | [`skills/`](skills/) — 1170 skills, one `SKILL.md` each, plus 12 retired aliases kept so old names still resolve (~9 MB total) | ✔ |
...
## The fast clone (skill authors: 10 seconds, ~10 MB)
...
|---|---|---|
| `skills/` | **The product.** 1170 skill definitions (+12 retired aliases) + their references/templates/scripts | hand-written |
