...
| **Read/copy skills** | [`skills/`](skills/) — 1166 skills, one `SKILL.md` each, plus 12 retired aliases kept so old names still resolve (~9 MB total) | ✔ |
...
|---|---|---|
| `skills/` | **The product.** 1166 skill definitions (+12 retired aliases) + their references/templates/scripts | hand-written |
