...
| **Read/copy skills** | [`skills/`](skills/) — 1175 folders, one `SKILL.md` each (~9 MB total) | ✔ |
...
|---|---|---|
| `skills/` | **The product.** 1175 skill definitions + their references/templates/scripts | hand-written |
