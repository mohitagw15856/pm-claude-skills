...
| **Read/copy skills** | [`skills/`](skills/) — 1162 skills, one `SKILL.md` each, plus 12 retired aliases kept so old names still resolve (~9 MB total) | ✔ |
...
|---|---|---|
| `skills/` | **The product.** 1162 skill definitions (+12 retired aliases) + their references/templates/scripts | hand-written |
