...
| **Read/copy skills** | [`skills/`](skills/) — 1154 folders, one `SKILL.md` each (~9 MB total) | ✔ |
...
|---|---|---|
| `skills/` | **The product.** 1154 skill definitions + their references/templates/scripts | hand-written |
