...
const urls = [
  ...
  `${BASE}/coverage.html`, `${BASE}/canvas.html`, `${BASE}/boardroom.html`, `${BASE}/defend.html`, `${BASE}/verify.html`, `${BASE}/gym.html`, `${BASE}/xray.html`, `${BASE}/grade.html`, `${BASE}/benchmark.html`,
