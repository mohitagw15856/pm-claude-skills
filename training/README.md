...
| Step | State |
|---|---|
| 1. Dataset | ✅ `node training/build-sft-dataset.mjs` → `sft.jsonl` (646 pairs: routing + structure, from all 1058 skills + the 153 eval inputs) |
...
**Honest expectations:** a 7B LoRA on 646 pairs learns *routing* and *structural discipline* convincingly; it does not learn the full depth of 1058 skills. It's a demonstration artifact and a fast local router — the claim to publish is exactly that, no more.
